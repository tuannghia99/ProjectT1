...
namespace ProjectY.Report.Infrastructure {
    public class PM_01_2022_PL01_ReportPrintParameter : PrintParameterBase {
        public PM_01_2022_PL01_ReportPrintParameter() : base("") { }
        public PM_01_2022_PL01_ReportPrintParameter(string PrintObjectID, ISessionAPI _sessionAPI) : base(PrintObjectID) {
            PrintDateTime = DateTime.Now;
            PrintUserName = _sessionAPI.CurrentUser?.UserName;
            ServiceToken = _sessionAPI.ServiceToken;
        }
        public PM_01_2022_PL01_ReportPrintParameter(string PrintObjectID) : base(PrintObjectID) {
        }

        public PM_01_2022_PL01_ReportPrintParameter(SerializationInfo info, StreamingContext context) : base(info, context) { }
